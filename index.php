			...
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="header-hero-content text-center">
						<h3 class="header-sub-title animate__animated animate__slideInDown">Hi, I am Kuntal Sarkar</h3>
						<h2 class="header-title mt-10 aos-init aos-animate" data-aos="zoom-in" data-aos-delay="180">
						...
						<p class="header-text animate__animated animate__bounceIn animate__delay-2s">
